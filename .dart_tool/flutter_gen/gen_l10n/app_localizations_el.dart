...
class I18NEl extends I18N {
  I18NEl([String locale = 'el']) : super(locale);
  ...
  @override
  String get accountDetails => 'Λεπτομέρειες Λογαριασμού';

  @override
  String get actions => 'Ενέργειες';

  @override
  String get actionsNone => 'Καμία διαθέσιμη ενέργεια';

  @override
  String get add => 'Προσθήκη';

  @override
  String get addStock => 'Προσθήκη Αποθέματος';

  @override
  String get address => 'Διεύθυνση';

  @override
  String get appAbout => 'Σχετικά με το InvenTree';

  @override
  String get appCredits => 'Πρόσθετες μονάδες εφαρμογής';

  @override
  String get appDetails => 'Λεπτομέρειες εφαρμογής';

  @override
  String get allocated => 'Κατανεμημένο';

  @override
  String get allocateStock => 'Κατανομή Αποθέματος';

  @override
  String get appReleaseNotes => 'Προβολή πληροφοριών έκδοσης εφαρμογής';

  @override
  String get appSettings => 'Ρυθμίσεις Εφαρμογής';

  @override
  String get appSettingsDetails => 'Διαμόρφωση ρυθμίσεων της εφαρμογής InvenTree';
  ...
  @override
  String get attachmentNone => 'Δε βρέθηκαν συνημμένα';

  @override
  String get attachmentNoneDetail => 'Δεν βρέθηκαν συνημμένα';

  @override
  String get attachmentSelect => 'Επιλογή επισύναψης';

  @override
  String get attention => 'Προσοχή';

  @override
  String get available => 'Διαθέσιμο';

  @override
  String get availableStock => 'Διαθέσιμο Απόθεμα';

  @override
  String get barcodes => 'Barcodes';

  @override
  String get barcodeSettings => 'Ρυθμίσεις Barcode';

  @override
  String get barcodeAssign => 'Αντιστοίχιση Barcode';

  @override
  String get barcodeAssignDetail => 'Σαρώστε προσαρμοσμένο barcode για ανάθεση';

  @override
  String get barcodeAssigned => 'Το Βarcode καταχωρήθηκε';

  @override
  String get barcodeError => 'Σφάλμα σάρωσης Barcode';

  @override
  String get barcodeInUse => 'Το Barcode έχει ήδη ανατεθεί';

  @override
  String get barcodeMissingHash => 'Λείπουν δεδομένα κατακερματισμού Barcode από την απόκριση';

  @override
  String get barcodeNoMatch => 'Δεν υπάρχει αντιστοιχία με το barcode';

  @override
  String get barcodeNotAssigned => 'Το Βarcode δεν καταχωρήθηκε';

  @override
  String get barcodeScanPart => 'Σάρωση barcode εξαρτήματος';

  @override
  String get barcodeReceivePart => 'Σάρωση barcode για λήψη εξαρτήματος';

  @override
  String get barcodeScanPaused => 'Παύση σάρωσης barcode';

  @override
  String get barcodeScanPause => 'Πατήστε ή κρατήστε πατημένο για να κάνετε παύση σάρωσης';

  @override
  String get barcodeScanAssign => 'Σάρωση για εκχώρηση barcode';

  @override
  String get barcodeScanController => 'Είσοδος Σαρωτή';

  @override
  String get barcodeScanControllerDetail => 'Επιλέξτε πηγή εισόδου για σαρωτή barcode';
  ...
  @override
  String get categoryCreate => 'Νέα Κατηγορία';
  ...
  @override
  String get deleteFailed => 'Delete operation failed';

  @override
  String get deletePart => 'Delete Part';

  @override
  String get deletePartDetail => 'Remove this part from the database';

  @override
  String get deleteSuccess => 'Delete operation successful';
...
class I18NElGr extends I18NEl {
  I18NElGr(): super('el_GR');
